...
const organisationTabs = ["info", "members", "issues", "features"];

type SettingsOrganisationTab = (typeof organisationTabs)[number];

function getInitialTab(): SettingsOrganisationTab {
  return "info";
}

function getValidTab(value: string): SettingsOrganisationTab {
  return organisationTabs.includes(value as SettingsOrganisationTab)
    ? (value as SettingsOrganisationTab)
    : "info";
}

export function SettingsOrganisation() {
  ...
  const [activeTab, setActiveTab] = useState<SettingsOrganisationTab>(() => getInitialTab());
  ...
  }, [invalidateMembers, selectedOrganisationId]);

  return (
    <section className="flex flex-1 flex-col gap-3 border p-3 overflow-auto">
      <h2 className="text-xl font-600">Organisation settings</h2>
        ...
        {selectedOrganisation ? (
          ...
          >
            ...
            <TabsContent value="members" className="flex-1 min-h-0">
              <div className="border p-2 min-w-0 overflow-hidden min-h-0 flex flex-col">
                    ...
                    <AddMember
                      ...
                      trigger={
                        <Button variant="outline">
                          Add member <Icon icon="plus" className="size-4" />
                        </Button>
                      }
                    />
                  )}
            ...
            <TabsContent value="issues">
              <div className="flex flex-wrap gap-2 items-start">
                {/* Issue Types section */}
                <div className="border p-2 min-w-[22rem] flex-1 overflow-hidden">
